...
if __name__ == "__main__":
    ...
    # blocks = [BreakoutBlock(100, 100, block_width, block_height)]
    ...
    ball_dx = 0
    ball_dy = 100
    # balls = [BreakoutBall(ball_x, ball_y, ball_dx + 10 * i, ball_dy, ball_radius) for i in range(-5, 5, 1)]
    balls = [BreakoutBall(80, 120, 500, 500, ball_radius)]
    # ball = BreakoutBall()
    
    collision_grid_shape = (20, 20)
